...
import 'package:sha_admin/02_application/auth/auth_bloc.dart' as _i12;
import 'package:sha_admin/02_application/category/category_bloc.dart' as _i13;
import 'package:sha_admin/02_application/product/product_bloc.dart' as _i11;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i11.ProductBloc>(
        () => _i11.ProductBloc(gh<_i9.IProductRepo>()));
    gh.factory<_i12.AuthBloc>(() => _i12.AuthBloc(gh<_i5.IAuthRepo>()));
    gh.factory<_i13.CategoryBloc>(
        () => _i13.CategoryBloc(gh<_i7.ICategoryRepo>()));
    return this;
  }
}
