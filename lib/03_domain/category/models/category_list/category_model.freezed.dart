...
class _$_CategoryModel implements _CategoryModel {
  _$_CategoryModel(
      ...
      @JsonKey(name: 'category_image') this.image,
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, image: $image, categoryName: $categoryName, offer: $offer)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, image, categoryName, offer);
...
abstract class _CategoryModel implements CategoryModel {
  factory _CategoryModel(
      ...
      @JsonKey(name: 'category_image') final String? image,
      @JsonKey(name: 'category_name') final String? categoryName,
      final int? offer}) = _$_CategoryModel;
